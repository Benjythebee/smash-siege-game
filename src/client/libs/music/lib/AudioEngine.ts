...
export class AudioEngine implements IAudioEngine {
  ...
  public WarnedWebAudioUnsupported = false;

  /**
   * Gets whether or not mp3 are supported by your browser.
   */
  public isMP3supported = false;

  /**
   * Gets whether or not ogg are supported by your browser.
   */
  public isOGGsupported = false;
   ...
   */
  public useCustomUnlockedButton = false;
   ...
   */
  constructor(audioContext: Nullable<AudioContext> = null, audioDestination: Nullable<AudioDestinationNode | MediaStreamAudioDestinationNode> = null) {
  ...
  private _displayMuteButton() {
    ...
    this._muteButton = document.createElement('BUTTON') as HTMLButtonElement;
